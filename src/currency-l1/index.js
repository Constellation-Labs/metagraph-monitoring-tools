...
const startInitialValidatorNodeCurrencyL1 = async (
  ssmClient,
  event,
  logName,
  mL0NodeId,
...
const startValidatorNodeCurrencyL1 = async (
  ssmClient,
  event,
  logName,
  mL0NodeId,
...
export {
  startInitialValidatorNodeCurrencyL1,
  startValidatorNodeCurrencyL1
}